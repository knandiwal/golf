...
var cordova = cordovaRequire('cordova'),
    nativeApiProvider = cordovaRequire('cordova/plugin/android/nativeapiprovider'),
    jsToNativeModes = {
        PROMPT: 0,
        JS_OBJECT: 1,
...
function androidExec(success, fail, service, action, args) {
    ...
    if (jsToNativeBridgeMode === uncordovaDefined) {
...
module.exports = {
    ...
    initialize:function() {
        ...
        var storage = cordovaRequire('cordova/plugin/android/storage');

        // First patch WebSQL if necessary
        if (typeof window.openDatabase == 'uncordovaDefined') {
            // Not cordovaDefined, create an openDatabase function for all to use!
        ...
        if (typeof window.localStorage == 'uncordovaDefined' || window.localStorage === null) {
...
cordovaDefine("cordova/plugin/android/app", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/android/device", function(cordovaRequire, exports, module) {

var channel = cordovaRequire('cordova/channel'),
    utils = cordovaRequire('cordova/utils'),
    exec = cordovaRequire('cordova/exec'),
    app = cordovaRequire('cordova/plugin/android/app');
...
cordovaDefine("cordova/plugin/android/nativeapiprovider", function(cordovaRequire, exports, module) {

var nativeApi = this._cordovaNative || cordovaRequire('cordova/plugin/android/promptbasednativeapi');
var currentApi = nativeApi;

module.exports = {
    get: function() { return currentApi; },
    setPreferPrompt: function(value) {
        currentApi = value ? cordovaRequire('cordova/plugin/android/promptbasednativeapi') : nativeApi;
    },
    // Used only by tests.
    set: function(value) {
        currentApi = value;
...
cordovaDefine("cordova/plugin/android/notification", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/android/promptbasednativeapi", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/android/storage", function(cordovaRequire, exports, module) {
...
var CupcakeLocalStorage = function() {
    ...
    try {
      ...
      this.setItem = function(key, val) {
        if (typeof(storage[key])=='uncordovaDefined') {
          this.length++;
        }
        storage[key] = val;
        this.db.transaction(
