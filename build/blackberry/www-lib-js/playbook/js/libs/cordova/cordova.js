...
cordovaDefine("cordova/plugin/air/DirectoryEntry", function(cordovaRequire, exports, module) {

var DirectoryEntry = cordovaRequire('cordova/plugin/DirectoryEntry'),
    DirectoryReader = cordovaRequire('cordova/plugin/air/DirectoryReader'),
...
cordovaDefine("cordova/plugin/air/DirectoryReader", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/air/Entry", function(cordovaRequire, exports, module) {

var FileError = cordovaRequire('cordova/plugin/FileError'),
    LocalFileSystem = cordovaRequire('cordova/plugin/LocalFileSystem'),
    Metadata = cordovaRequire('cordova/plugin/Metadata'),
    resolveLocalFileSystemURI = cordovaRequire('cordova/plugin/air/resolveLocalFileSystemURI'),
    DirectoryEntry = cordovaRequire('cordova/plugin/DirectoryEntry'),
    FileEntry = cordovaRequire('cordova/plugin/FileEntry'),
    requestFileSystem = cordovaRequire('cordova/plugin/air/requestFileSystem');
...
cordovaDefine("cordova/plugin/air/File", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/air/FileEntry", function(cordovaRequire, exports, module) {

var FileEntry = cordovaRequire('cordova/plugin/FileEntry'),
    Entry = cordovaRequire('cordova/plugin/air/Entry'),
    FileWriter = cordovaRequire('cordova/plugin/air/FileWriter'),
    File = cordovaRequire('cordova/plugin/air/File'),
    FileError = cordovaRequire('cordova/plugin/FileError');
...
cordovaDefine("cordova/plugin/air/FileReader", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/air/FileTransfer", function(cordovaRequire, exports, module) {

var cordova = cordovaRequire('cordova'),
FileTransferError = cordovaRequire('cordova/plugin/FileTransferError'),
FileUploadResult = cordovaRequire('cordova/plugin/FileUploadResult');
...
cordovaDefine("cordova/plugin/air/FileWriter", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/air/battery", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/air/camera", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/air/capture", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/air/device", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/air/network", function(cordovaRequire, exports, module) {

var cordova = cordovaRequire('cordova'),
    connection = cordovaRequire('cordova/plugin/Connection');
...
cordovaDefine("cordova/plugin/air/requestFileSystem", function(cordovaRequire, exports, module) {
...
cordovaDefine("cordova/plugin/air/resolveLocalFileSystemURI", function(cordovaRequire, exports, module) {
...
var cordova = cordovaRequire('cordova'),
    plugins = {
        'Device' : cordovaRequire('cordova/plugin/air/device'),
        'Battery' : cordovaRequire('cordova/plugin/air/battery'),
        'Camera' : cordovaRequire('cordova/plugin/air/camera'),
        'Logger' : cordovaRequire('cordova/plugin/webworks/logger'),
        'Media' : cordovaRequire('cordova/plugin/webworks/media'),
        'Capture' : cordovaRequire('cordova/plugin/air/capture'),
        'Accelerometer' : cordovaRequire('cordova/plugin/webworks/accelerometer'),
        'NetworkStatus' : cordovaRequire('cordova/plugin/air/network'),
        'Notification' : cordovaRequire('cordova/plugin/webworks/notification'),
        'FileTransfer' : cordovaRequire('cordova/plugin/air/FileTransfer')
    };
...
cordovaRequire('cordova/channel').onNativeReady.fire();
